...
<a class="sourceLine" id="cb3-26" title="26">            namespace: <span class="cn">None</span>,</a>
<a class="sourceLine" id="cb3-27" title="27">            did_mount: <span class="cn">None</span>,</a>
<a class="sourceLine" id="cb3-28" title="28">            did_update: <span class="cn">None</span>,</a>
<a class="sourceLine" id="cb3-29" title="29">            will_unmount: <span class="cn">None</span>,</a>
<a class="sourceLine" id="cb3-30" title="30">        <span class="op">}</span>,</a>
<a class="sourceLine" id="cb3-31" title="31">        El <span class="op">{</span></a>
<a class="sourceLine" id="cb3-32" title="32">            tag: <span class="pp">Tag::</span>button,</a>
<a class="sourceLine" id="cb3-33" title="33">            attrs: Attrs <span class="op">{</span> vals: <span class="pp">HashMap::</span>new() <span class="op">}</span>,</a>
<a class="sourceLine" id="cb3-34" title="34">            style: Style <span class="op">{</span> vals: <span class="pp">HashMap::</span>new() <span class="op">}</span>,</a>
<a class="sourceLine" id="cb3-35" title="35">            listeners: <span class="dt">Vec</span>::new();</a>
<a class="sourceLine" id="cb3-36" title="36">            text: <span class="cn">Some</span>(<span class="dt">String</span>::from(<span class="st">&quot;Click me!&quot;</span>)),</a>
<a class="sourceLine" id="cb3-37" title="37">            children: <span class="dt">Vec</span>::new(),</a>
<a class="sourceLine" id="cb3-38" title="38">            id: <span class="cn">None</span>,</a>
<a class="sourceLine" id="cb3-39" title="39">            next_level: <span class="cn">None</span>,</a>
<a class="sourceLine" id="cb3-40" title="40">            el_ws: <span class="cn">None</span>,</a>
<a class="sourceLine" id="cb3-41" title="41">            raw_html: <span class="cn">false</span>,</a>
<a class="sourceLine" id="cb3-42" title="42">            text_node: <span class="cn">false</span>,</a>
