...
<p>For a better understanding of how views are created, reference the <a href="https://docs.rs/seed/0.2.1/seed/dom_types/struct.El.html">El API docs page</a>. The following code returns an <code>El</code> representing a few nested DOM elements displayed in a flexbox layout:</p>
