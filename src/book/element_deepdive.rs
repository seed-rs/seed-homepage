...
<p>For a better understanding of how views are created, reference the <a href="https://docs.rs/seed/0.3.7/seed/dom_types/struct.El.html">El API docs page</a>. The following code returns an <code>El</code> representing a few nested DOM elements displayed in a flexbox layout:</p>
...
<div class="sourceCode" id="cb3"><pre class="sourceCode rust"><code class="sourceCode rust"><span id="cb3-1"><a href="#cb3-1"></a><span class="co">// We don&#39;t provide an example of a Listener: These are more complicated to </span></span>
...
<span id="cb3-26"><a href="#cb3-26"></a>            raw_html: <span class="cn">false</span>,</span>
<span id="cb3-27"><a href="#cb3-27"></a>            text_node: <span class="cn">false</span>,</span>
<span id="cb3-28"><a href="#cb3-28"></a>            namespace: <span class="cn">None</span>,</span>
<span id="cb3-29"><a href="#cb3-29"></a>            did_mount: <span class="cn">None</span>,</span>
<span id="cb3-30"><a href="#cb3-30"></a>            did_update: <span class="cn">None</span>,</span>
<span id="cb3-31"><a href="#cb3-31"></a>            will_unmount: <span class="cn">None</span>,</span>
<span id="cb3-32"><a href="#cb3-32"></a>        <span class="op">}</span>,</span>
<span id="cb3-33"><a href="#cb3-33"></a>        El <span class="op">{</span></span>
<span id="cb3-34"><a href="#cb3-34"></a>            tag: <span class="pp">Tag::</span>button,</span>
<span id="cb3-35"><a href="#cb3-35"></a>            attrs: Attrs <span class="op">{</span> vals: <span class="pp">HashMap::</span>new() <span class="op">}</span>,</span>
<span id="cb3-36"><a href="#cb3-36"></a>            style: Style <span class="op">{</span> vals: <span class="pp">HashMap::</span>new() <span class="op">}</span>,</span>
<span id="cb3-37"><a href="#cb3-37"></a>            listeners: <span class="dt">Vec</span>::new();</span>
<span id="cb3-38"><a href="#cb3-38"></a>            text: <span class="cn">Some</span>(<span class="dt">String</span>::from(<span class="st">&quot;Click me!&quot;</span>)),</span>
<span id="cb3-39"><a href="#cb3-39"></a>            children: <span class="dt">Vec</span>::new(),</span>
<span id="cb3-40"><a href="#cb3-40"></a>            id: <span class="cn">None</span>,</span>
<span id="cb3-41"><a href="#cb3-41"></a>            next_level: <span class="cn">None</span>,</span>
<span id="cb3-42"><a href="#cb3-42"></a>            el_ws: <span class="cn">None</span>,</span>
<span id="cb3-43"><a href="#cb3-43"></a>            raw_html: <span class="cn">false</span>,</span>
<span id="cb3-44"><a href="#cb3-44"></a>            text_node: <span class="cn">false</span>,</span>
<span id="cb3-45"><a href="#cb3-45"></a>            namespace: <span class="cn">None</span>,</span>
<span id="cb3-46"><a href="#cb3-46"></a>            did_mount: <span class="cn">None</span>,</span>
<span id="cb3-47"><a href="#cb3-47"></a>            did_update: <span class="cn">None</span>,</span>
<span id="cb3-48"><a href="#cb3-48"></a>            will_unmount: <span class="cn">None</span>,</span>
<span id="cb3-49"><a href="#cb3-49"></a>        <span class="op">}</span> </span>
<span id="cb3-50"><a href="#cb3-50"></a>    <span class="op">]</span></span>
<span id="cb3-51"><a href="#cb3-51"></a><span class="op">}</span></span></code></pre></div>
