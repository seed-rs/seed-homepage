...
<p>We use the <a href="https://docs.rs/seed/0.3.7/seed/fetch/struct.Request.html">seed::Request</a> struct to make HTTP requests in the browser, wrapping the <a href="https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API">Fetch API</a>. To use this, we need to include <code>futures = "^0.1.26"</code> in <code>Cargo.toml</code>. The <a href="https://docs.rs/seed/0.3.7/seed/fetch/index.html">Fetch module</a> is standalone: It can be used with any wasm-bindgen program.</p>
...
<span id="cb1-20"><a href="#cb1-20"></a>        label: &amp;<span class="ot">&#39;static</span> <span class="dt">str</span>,</span>
...
<span id="cb1-59"><a href="#cb1-59"></a><span class="kw">fn</span> view(model: &amp;Model) -&gt; El&lt;Msg&gt; <span class="op">{</span></span>
...
<div class="sourceCode" id="cb2"><pre class="sourceCode rust"><code class="sourceCode rust"><span id="cb2-1"><a href="#cb2-1"></a><span class="kw">fn</span> view(model: &amp;Model) -&gt; <span class="dt">Vec</span>&lt;El&lt;Msg&gt;&gt; <span class="op">{</span></span>
...
<span id="cb3-18"><a href="#cb3-18"></a>        label: &amp;<span class="ot">&#39;static</span> <span class="dt">str</span>,</span>
...
<span id="cb3-65"><a href="#cb3-65"></a><span class="kw">fn</span> view(model: &amp;Model) -&gt;El&lt;Msg&gt; <span class="op">{</span></span>
...
<div class="sourceCode" id="cb4"><pre class="sourceCode rust"><code class="sourceCode rust"><span id="cb4-1"><a href="#cb4-1"></a><span class="kw">fn</span> view(model: &amp;Model) -&gt; El&lt;Msg&gt; <span class="op">{</span>  </span>
