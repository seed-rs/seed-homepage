...
<a class="sourceLine" id="cb1-59" title="59"><span class="kw">fn</span> view(model: &amp;Model) -&gt; Node&lt;Msg&gt; <span class="op">{</span></a>
...
<a class="sourceLine" id="cb3-65" title="65"><span class="kw">fn</span> view(model: &amp;Model) -&gt;Node&lt;Msg&gt;&gt; <span class="op">{</span></a>
