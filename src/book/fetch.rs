...
<a class="sourceLine" id="cb1-2" title="2"><span class="kw">pub</span> <span class="kw">struct</span> Commit <span class="op">{</span></a>
<a class="sourceLine" id="cb1-3" title="3">    <span class="kw">pub</span> sha: <span class="dt">String</span>,</a>
<a class="sourceLine" id="cb1-4" title="4"><span class="op">}</span></a>
<a class="sourceLine" id="cb1-5" title="5"></a>
<a class="sourceLine" id="cb1-6" title="6"><span class="at">#[</span>derive<span class="at">(</span><span class="bu">Clone</span><span class="at">,</span> <span class="bu">Debug</span><span class="at">,</span> Serialize<span class="at">,</span> Deserialize<span class="at">)]</span></a>
<a class="sourceLine" id="cb1-7" title="7"><span class="kw">pub</span> <span class="kw">struct</span> Branch <span class="op">{</span></a>
<a class="sourceLine" id="cb1-8" title="8">    <span class="kw">pub</span> name: <span class="dt">String</span>,</a>
<a class="sourceLine" id="cb1-9" title="9">    <span class="kw">pub</span> commit: Commit,</a>
<a class="sourceLine" id="cb1-10" title="10"><span class="op">}</span></a>
<a class="sourceLine" id="cb1-11" title="11"></a>
<a class="sourceLine" id="cb1-12" title="12"><span class="at">#[</span>derive<span class="at">(</span><span class="bu">Clone</span><span class="at">)]</span></a>
<a class="sourceLine" id="cb1-13" title="13"><span class="kw">enum</span> Msg <span class="op">{</span></a>
<a class="sourceLine" id="cb1-14" title="14">    Replace(Branch),</a>
<a class="sourceLine" id="cb1-15" title="15"><span class="op">}</span></a>
<a class="sourceLine" id="cb1-16" title="16"></a>
<a class="sourceLine" id="cb1-17" title="17"><span class="kw">fn</span> update(msg: Msg, model: Model) -&gt; Model <span class="op">{</span></a>
<a class="sourceLine" id="cb1-18" title="18">    <span class="kw">match</span> msg <span class="op">{</span></a>
<a class="sourceLine" id="cb1-19" title="19">        <span class="pp">Msg::</span>Replace(data) =&gt; <span class="op">{</span></a>
<a class="sourceLine" id="cb1-20" title="20">            Model <span class="op">{</span>data<span class="op">}</span></a>
...
<a class="sourceLine" id="cb1-29" title="29">        app.update_dom(<span class="pp">Msg::</span>Replace(data));</a>
...
<a class="sourceLine" id="cb1-35" title="35"><span class="kw">fn</span> view(app: <span class="pp">seed::</span>App&lt;Msg, Model&gt;, model: Model) -&gt; El&lt;Msg&gt; <span class="op">{</span></a>
...
<p>Important: Setting Content-Type is currently broken, which affects many POST requests. Standby for a fix.</p>
<p>Example showing POST, and headers:</p>
<div class="sourceCode" id="cb3"><pre class="sourceCode rust"><code class="sourceCode rust"><a class="sourceLine" id="cb3-1" title="1"><span class="kw">fn</span> post_data() <span class="op">{</span></a>
<a class="sourceLine" id="cb3-2" title="2">    <span class="kw">let</span> url = <span class="st">&quot;https://infinitea.herokuapp.com/api/contact&quot;</span>;</a>
<a class="sourceLine" id="cb3-3" title="3"></a>
<a class="sourceLine" id="cb3-4" title="4">    <span class="kw">let</span> opts = <span class="pp">seed::</span>RequestOpts <span class="op">{</span></a>
<a class="sourceLine" id="cb3-5" title="5">        payload: <span class="cn">Some</span>(</a>
<a class="sourceLine" id="cb3-6" title="6">            <span class="pp">hashmap_string!</span><span class="op">{</span></a>
<a class="sourceLine" id="cb3-7" title="7">                <span class="st">&quot;name&quot;</span> =&gt; <span class="st">&quot;Mark Watney&quot;</span>,</a>
<a class="sourceLine" id="cb3-8" title="8">                <span class="st">&quot;email&quot;</span> =&gt; <span class="st">&quot;mark@crypt.kn&quot;</span>,</a>
<a class="sourceLine" id="cb3-9" title="9">                <span class="st">&quot;message&quot;</span> =&gt; <span class="st">&quot;I wanna be like Iron Man.&quot;</span>,</a>
<a class="sourceLine" id="cb3-10" title="10">            <span class="op">}</span></a>
<a class="sourceLine" id="cb3-11" title="11">        ),</a>
<a class="sourceLine" id="cb3-12" title="12">        headers: <span class="cn">Some</span>(  <span class="co">// todo try without headers</span></a>
<a class="sourceLine" id="cb3-13" title="13">            <span class="pp">hashmap_string!</span><span class="op">{</span></a>
<a class="sourceLine" id="cb3-14" title="14">                <span class="st">&quot;Content-Type&quot;</span> =&gt; <span class="st">&quot;application/json&quot;</span>,</a>
<a class="sourceLine" id="cb3-15" title="15">            <span class="op">}</span></a>
<a class="sourceLine" id="cb3-16" title="16">        ),</a>
<a class="sourceLine" id="cb3-17" title="17">        credentials: <span class="cn">None</span>,</a>
<a class="sourceLine" id="cb3-18" title="18">    <span class="op">}</span>;</a>
<a class="sourceLine" id="cb3-19" title="19"></a>
<a class="sourceLine" id="cb3-20" title="20">    <span class="kw">let</span> callback = <span class="kw">move</span> |json: JsValue| <span class="op">{</span></a>
<a class="sourceLine" id="cb3-21" title="21">        <span class="co">// We can do something with the response here.</span></a>
<a class="sourceLine" id="cb3-22" title="22">    <span class="op">}</span>;</a>
<a class="sourceLine" id="cb3-23" title="23">    <span class="pp">seed::</span>post(url, <span class="cn">Some</span>(opts), <span class="dt">Box</span>::new(callback));</a>
<a class="sourceLine" id="cb3-24" title="24"><span class="op">}</span></a></code></pre></div>
<p>Note the use of the hashmap_string! macro. This is a HashMap literal that converts both key and value to Strings. (eg from &amp;strs here).</p>
"#.into()
}