...
<p>We use the <a href="https://docs.rs/seed/0.3.4/seed/fetch/struct.Request.html">seed::Request</a> struct to make HTTP requests in the browser, wrapping the <a href="https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API">Fetch API</a>. To use this, we need to include <code>futures = "^0.1.20"</code> in <code>Cargo.toml</code>. The <a href="https://docs.rs/seed/0.3.4/seed/fetch/index.html">Fetch module</a> is standalone: It can be used with any wasm-bindgen program.</p>
...
<a class="sourceLine" id="cb1-17" title="17">    Replace(Branch),</a>
<a class="sourceLine" id="cb1-18" title="18">    GetData,</a>
<a class="sourceLine" id="cb1-19" title="19">    <span class="bu">Send</span>,</a>
<a class="sourceLine" id="cb1-20" title="20">    OnServerResponse(ServerResponse),</a>
...
<a class="sourceLine" id="cb1-30" title="30">        <span class="pp">Msg::</span>GetData =&gt; <span class="pp">Update::</span>with_future_msg(get_data()).skip(),</a>
<a class="sourceLine" id="cb1-31" title="31"></a>
<a class="sourceLine" id="cb1-32" title="32">        <span class="pp">Msg::</span><span class="bu">Send</span> =&gt; <span class="pp">Update::</span>with_future_msg(send()).skip(),</a>
<a class="sourceLine" id="cb1-33" title="33"></a>
<a class="sourceLine" id="cb1-34" title="34">        <span class="pp">Msg::</span>OnServerResponse(result) =&gt; <span class="op">{</span></a>
<a class="sourceLine" id="cb1-35" title="35">            <span class="pp">log!</span>(<span class="pp">format!</span>(<span class="st">&quot;Response: {:#?}&quot;</span>, result));</a>
<a class="sourceLine" id="cb1-36" title="36">            Skip</a>
<a class="sourceLine" id="cb1-37" title="37">        <span class="op">}</span></a>
<a class="sourceLine" id="cb1-38" title="38"></a>
<a class="sourceLine" id="cb1-39" title="39">        <span class="pp">Msg::</span>OnFetchErr(err) =&gt; <span class="op">{</span></a>
<a class="sourceLine" id="cb1-40" title="40">            <span class="pp">log!</span>(<span class="pp">format!</span>(<span class="st">&quot;Fetch error: {:#?}&quot;</span>, err));</a>
<a class="sourceLine" id="cb1-41" title="41">            Skip</a>
...
<a class="sourceLine" id="cb1-46" title="46"><span class="kw">fn</span> get_data() -&gt; <span class="kw">impl</span> Future&lt;Item = Msg, Error = Msg&gt; <span class="op">{</span></a>
<a class="sourceLine" id="cb1-47" title="47">    <span class="kw">let</span> url = <span class="st">&quot;https://api.github.com/repos/david-oconnor/seed/branches/master&quot;</span>;</a>
<a class="sourceLine" id="cb1-48" title="48"></a>
<a class="sourceLine" id="cb1-49" title="49">    <span class="pp">Request::</span>new(url)</a>
<a class="sourceLine" id="cb1-50" title="50">        .method(<span class="pp">Method::</span>Get)</a>
<a class="sourceLine" id="cb1-51" title="51">        .fetch_json()</a>
<a class="sourceLine" id="cb1-52" title="52">        .map(<span class="pp">Msg::</span>Replace)</a>
<a class="sourceLine" id="cb1-53" title="53">        .map_err(<span class="pp">Msg::</span>OnFetchErr)</a>
<a class="sourceLine" id="cb1-54" title="54"><span class="op">}</span></a>
<a class="sourceLine" id="cb1-55" title="55"></a>
<a class="sourceLine" id="cb1-56" title="56"><span class="kw">fn</span> view(model: &amp;Model) -&gt; El&lt;Msg&gt; <span class="op">{</span></a>
<a class="sourceLine" id="cb1-57" title="57">    <span class="pp">div!</span><span class="op">[</span> <span class="pp">format!</span>(<span class="st">&quot;name: {}, sha: {}&quot;</span>, model.data.name, model.data.commit.sha),</a>
<a class="sourceLine" id="cb1-58" title="58">        did_mount(<span class="kw">move</span> |_| spawn_local(get_data(state.clone())))</a>
...
<a class="sourceLine" id="cb1-63" title="63"><span class="at">#[</span>wasm_bindgen<span class="at">]</span></a>
<a class="sourceLine" id="cb1-64" title="64"><span class="kw">pub</span> <span class="kw">fn</span> render() <span class="op">{</span></a>
<a class="sourceLine" id="cb1-65" title="65">    <span class="kw">let</span> state = <span class="pp">seed::App::</span>build(<span class="pp">Model::</span><span class="kw">default</span>(), update, view)</a>
<a class="sourceLine" id="cb1-66" title="66">        .finish()</a>
<a class="sourceLine" id="cb1-67" title="67">        .run();</a>
<a class="sourceLine" id="cb1-68" title="68"></a>
<a class="sourceLine" id="cb1-69" title="69">    state.update(<span class="pp">Msg::</span>GetData);</a></code></pre></div>
...
<div class="sourceCode" id="cb2"><pre class="sourceCode rust"><code class="sourceCode rust"><a class="sourceLine" id="cb2-1" title="1"><span class="kw">fn</span> update(msg: Msg, model: &amp;<span class="kw">mut</span> Model) -&gt; <span class="kw">impl</span> Updater&lt;Msg&gt; <span class="op">{</span></a>
<a class="sourceLine" id="cb2-2" title="2">    <span class="kw">match</span> msg <span class="op">{</span></a>
<a class="sourceLine" id="cb2-3" title="3">        <span class="pp">Msg::</span>Replace(data) =&gt; Render(Model <span class="op">{</span>data<span class="op">}</span>),</a>
<a class="sourceLine" id="cb2-4" title="4">        <span class="pp">Msg::</span>GetData(state) =&gt; <span class="op">{</span></a>
<a class="sourceLine" id="cb2-5" title="5">            spawn_local(get_data(state));</a>
<a class="sourceLine" id="cb2-6" title="6">            Render(model)</a>
<a class="sourceLine" id="cb2-7" title="7">        <span class="op">}</span>,</a>
<a class="sourceLine" id="cb2-8" title="8">    <span class="op">}</span></a>
<a class="sourceLine" id="cb2-9" title="9"><span class="op">}</span></a>
<a class="sourceLine" id="cb2-10" title="10"></a>
<a class="sourceLine" id="cb2-11" title="11"><span class="kw">fn</span> view(model: &amp;Model) -&gt; El&lt;Msg&gt; <span class="op">{</span></a>
<a class="sourceLine" id="cb2-12" title="12">    <span class="pp">div!</span><span class="op">[</span></a>
<a class="sourceLine" id="cb2-13" title="13">        <span class="pp">div!</span><span class="op">[</span> <span class="pp">format!</span>(<span class="st">&quot;Hello World. name: {}, sha: {}&quot;</span>, model.data.name, model.data.commit.sha) <span class="op">]</span>,</a>
<a class="sourceLine" id="cb2-14" title="14">        <span class="pp">button!</span><span class="op">[</span> raw_ev(<span class="pp">Ev::</span>Click, <span class="kw">move</span> |_| <span class="pp">Msg::</span>GetData), <span class="st">&quot;Update from the internet&quot;</span><span class="op">]</span></a>
...
<a class="sourceLine" id="cb3-13" title="13"><span class="kw">fn</span> send() -&gt; <span class="kw">impl</span> Future&lt;Item = Msg, Error = Msg&gt; <span class="op">{</span></a>
...
<a class="sourceLine" id="cb3-27" title="27">        .map(<span class="pp">Msg::</span>OnServerResponse)</a>
<a class="sourceLine" id="cb3-28" title="28">        .map_err(<span class="pp">Msg::</span>OnFetchErr)</a>
