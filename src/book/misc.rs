...
<a class="sourceLine" id="cb3-22" title="22">        <span class="pp">El::</span>from_markdown(markdown)   <span class="co">// or md!(markdown)</span></a>
<a class="sourceLine" id="cb3-23" title="23">        <span class="pp">El::</span>from_html(html)  <span class="co">// or raw!(html)</span></a>
...
<div class="sourceCode" id="cb4"><pre class="sourceCode rust"><code class="sourceCode rust"><a class="sourceLine" id="cb4-1" title="1"><span class="kw">fn</span> get_height(id: &amp;<span class="dt">str</span>) -&gt; <span class="dt">i32</span> <span class="op">{</span>    </a>
<a class="sourceLine" id="cb4-2" title="2">    <span class="kw">let</span> html_el = <span class="pp">seed::</span>document().get_element_by_id(<span class="st">&quot;my_el&quot;</span>).unwrap();</a>
<a class="sourceLine" id="cb4-3" title="3">    <span class="kw">let</span> h = html_el.client_height();    </a>
<a class="sourceLine" id="cb4-4" title="4">    <span class="pp">log!</span>(<span class="st">&quot;Height {:?}&quot;</span>, h); </a>
<a class="sourceLine" id="cb4-5" title="5">    h   </a>
...
<a class="sourceLine" id="cb5-3" title="3">        <span class="pp">button!</span><span class="op">[</span> </a>
<a class="sourceLine" id="cb5-4" title="4">            simple_ev(<span class="st">&quot;click&quot;</span>, <span class="pp">Msg::</span>Increment), </a>
<a class="sourceLine" id="cb5-5" title="5">            <span class="pp">format!</span>(<span class="st">&quot;Hello, World × {}&quot;</span>, model.val),</a>
<a class="sourceLine" id="cb5-6" title="6">            did_mount(|_| <span class="op">{</span></a>
<a class="sourceLine" id="cb5-7" title="7">                <span class="pp">seed::</span>document().set_title(<span class="st">&quot;New title&quot;</span>)</a>
...
<a class="sourceLine" id="cb6-3" title="3">        <span class="pp">svg!</span><span class="op">[</span></a>
<a class="sourceLine" id="cb6-4" title="4">            <span class="pp">attrs!</span><span class="op">{</span></a>
<a class="sourceLine" id="cb6-5" title="5">                <span class="pp">At::</span>Width =&gt; <span class="st">&quot;100%&quot;</span>;</a>
<a class="sourceLine" id="cb6-6" title="6">                <span class="pp">At::</span>Height =&gt; <span class="st">&quot;100%&quot;</span>;</a>
<a class="sourceLine" id="cb6-7" title="7">                <span class="pp">At::</span>ViewBox =&gt; <span class="st">&quot;0 0 512 512&quot;</span>;</a>
<a class="sourceLine" id="cb6-8" title="8">            <span class="op">}</span>,</a>
<a class="sourceLine" id="cb6-9" title="9">            <span class="pp">path!</span><span class="op">[</span> </a>
<a class="sourceLine" id="cb6-10" title="10">                <span class="pp">attrs!</span><span class="op">{</span></a>
<a class="sourceLine" id="cb6-11" title="11">                    <span class="pp">At::</span>Fill =&gt; <span class="st">&quot;lightgrey&quot;</span>;</a>
<a class="sourceLine" id="cb6-12" title="12">                    <span class="pp">At::</span>D =&gt; <span class="st">&quot;M345.863,281.853c19.152-8.872,38.221-15.344,56.1&quot;</span>  <span class="co">// etc</span></a>
<a class="sourceLine" id="cb6-13" title="13">                <span class="op">}</span></a>
<a class="sourceLine" id="cb6-14" title="14">            <span class="op">]</span>,</a>
<a class="sourceLine" id="cb6-15" title="15">            <span class="co">// More elements as required, eg mesh, polyline, circle</span></a>
