...
<p>To set up the initial routing, we pass a <code>routes</code> function describing how to handle routing, to <a href="https://docs.rs/seed/0.2.6/seed/struct.App.html#method.build">App::build</a>'s <code>routes</code> method.</p>
