...
<p>To set up the initial routing, we pass a <code>routes</code> function describing how to handle routing, to <a href="https://docs.rs/seed/0.2.5/seed/struct.App.html#method.build">App::build</a>'s <code>routes</code> method.</p>
...
<p>the <a href="https://docs.rs/seed/0.2.5/seed/routing/struct.Url.html">Url struct</a> which routes has the following fields, describes the route:</p>
