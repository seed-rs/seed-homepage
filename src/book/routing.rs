...
<p><a href="https://docs.rs/seed/0.2.0/seed/fn.push_route.html">seed::push_route</a> accepts a single parameter: a path &amp;str corresponding to what will be appended to the url. Currently, it must match one of the keys in the route map.</p>
