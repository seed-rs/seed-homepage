...
<p>The third parameter of the update function is an <a href="https://docs.rs/seed/0.3.7/seed/prelude/struct.Orders.html">Orders</a> struct, imported in the prelude. It has four methods, each defining an update behavior:</p>
<ul>
...
<p>Examples:</p>
<div class="sourceCode" id="cb6"><pre class="sourceCode rust"><code class="sourceCode rust"><span id="cb6-1"><a href="#cb6-1"></a><span class="kw">fn</span> view(model: &amp;Model) -&gt; El&lt;Msg&gt; <span class="op">{</span></span>
...
<div class="sourceCode" id="cb7"><pre class="sourceCode rust"><code class="sourceCode rust"><span id="cb7-1"><a href="#cb7-1"></a><span class="kw">fn</span> view(model: &amp;Model) -&gt; <span class="dt">Vec</span>&lt;El&lt;Msg&gt;&gt; <span class="op">{</span></span>
...
<p>These macros accept any combination of the following parameters: - One <a href="https://docs.rs/seed/0.3.7/seed/dom_types/struct.Attrs.html">Attrs</a> struct - One <a href="https://docs.rs/seed/0.3.7/seed/dom_types/struct.Style.html">Style</a> struct - One or more <a href="https://docs.rs/seed/0.3.7/seed/dom_types/struct.Listener.html">Listener</a> structs, which handle events - One or more <code>Vec</code>s of <code>Listener</code> structs - One <code>String</code> or <code>&amp;str</code> representing a node text - One or more <a href="https://docs.rs/seed/0.3.7/seed/dom_types/struct.El.html">El</a> structs, representing a child - One or more Vecs of <code>El</code> structs, representing multiple children - A <code>Map</code>, ie the result of <code>map()</code>, yielding <code>El</code>s or <code>Listener</code>s, without having to explicitly <code>collect</code>.</p>
...
<p>Views are described using <a href="https://docs.rs/seed/0.3.7/seed/dom_types/struct.El.html">El</a> structs, defined in the <a href="https://docs.rs/seed/0.3.7/seed/dom_types/index.html">seed::dom_types</a> module.</p>
...
<p>Example:</p>
<div class="sourceCode" id="cb9"><pre class="sourceCode rust"><code class="sourceCode rust"><span id="cb9-1"><a href="#cb9-1"></a><span class="kw">fn</span> view(model: &amp;Model) -&gt; El&lt;Msg&gt; <span class="op">{</span></span>
...
<span id="cb9-7"><a href="#cb9-7"></a>        things,  <span class="co">// Vec&lt;El&lt;Msg&gt;</span></span>
...
<div class="sourceCode" id="cb11"><pre class="sourceCode rust"><code class="sourceCode rust"><span id="cb11-1"><a href="#cb11-1"></a><span class="kw">fn</span> a_component() -&gt; El&lt;Msg&gt; <span class="op">{</span></span>
...
<div class="sourceCode" id="cb12"><pre class="sourceCode rust"><code class="sourceCode rust"><span id="cb12-1"><a href="#cb12-1"></a><span class="kw">fn</span> a_component() -&gt; El&lt;Msg&gt; <span class="op">{</span></span>
...
<div class="sourceCode" id="cb14"><pre class="sourceCode rust"><code class="sourceCode rust"><span id="cb14-1"><a href="#cb14-1"></a><span class="kw">fn</span> a_component() -&gt; El&lt;Msg&gt; <span class="op">{</span></span>
...
<div class="sourceCode" id="cb15"><pre class="sourceCode rust"><code class="sourceCode rust"><span id="cb15-1"><a href="#cb15-1"></a><span class="kw">fn</span> a_component() -&gt; El&lt;Msg&gt; <span class="op">{</span></span>
...
<div class="sourceCode" id="cb17"><pre class="sourceCode rust"><code class="sourceCode rust"><span id="cb17-1"><a href="#cb17-1"></a><span class="kw">fn</span> view(model: &amp;Model) -&gt; El&lt;Msg&gt; <span class="op">{</span></span>
...
<div class="sourceCode" id="cb18"><pre class="sourceCode rust"><code class="sourceCode rust"><span id="cb18-1"><a href="#cb18-1"></a><span class="kw">fn</span> a_component() -&gt; El&lt;Msg&gt; <span class="op">{</span></span>
