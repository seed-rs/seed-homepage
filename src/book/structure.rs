...
<p>The third parameter of the update function is an <a href="https://docs.rs/seed/0.3.6/seed/prelude/struct.Orders.html">Orders</a> struct, imported in the prelude. It has four methods, each defining an update behavior:</p>
<ul>
...
<p>These macros accept any combination of the following parameters: - One <a href="https://docs.rs/seed/0.3.6/seed/dom_types/struct.Attrs.html">Attrs</a> struct - One <a href="https://docs.rs/seed/0.3.6/seed/dom_types/struct.Style.html">Style</a> struct - One or more <a href="https://docs.rs/seed/0.3.6/seed/dom_types/struct.Listener.html">Listener</a> structs, which handle events - One or more <code>Vec</code>s of <code>Listener</code> structs - One <code>String</code> or <code>&amp;str</code> representing a node text - One or more <a href="https://docs.rs/seed/0.3.6/seed/dom_types/struct.El.html">El</a> structs, representing a child - One or more Vecs of <code>El</code> structs, representing multiple children - The result of <code>map()</code>, yielding <code>El</code>s or <code>Listener</code>s, without having to explicitly <code>collect</code>.</p>
...
<p>Views are described using <a href="https://docs.rs/seed/0.3.6/seed/dom_types/struct.El.html">El</a> structs, defined in the <a href="https://docs.rs/seed/0.3.6/seed/dom_types/index.html">seed::dom_types</a> module.</p>
