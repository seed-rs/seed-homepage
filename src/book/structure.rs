...
<a class="sourceLine" id="cb5-7" title="7">            Render(Model <span class="op">{</span>todos, ..model<span class="op">}</span>)</a>
...
<a class="sourceLine" id="cb5-15" title="15">            Render(Model <span class="op">{</span>todos, ..model<span class="op">}</span>)</a>
...
<a class="sourceLine" id="cb5-23" title="23">            Render(Model <span class="op">{</span>todos, ..model<span class="op">}</span>)</a>
...
<a class="sourceLine" id="cb5-30" title="30">            Render(Model <span class="op">{</span>todos, ..model<span class="op">}</span>)</a>
...
<a class="sourceLine" id="cb7-5" title="5">        <span class="pp">Msg::</span>B =&gt; Render(do_other_things(do_things(model))),</a>
...
<a class="sourceLine" id="cb8-5" title="5">        <span class="pp">Msg::</span>B =&gt; Render(do_other_things(update(<span class="pp">Msg::</span>A, model).model())),</a>
...
<a class="sourceLine" id="cb9-5" title="5">        <span class="pp">Msg::</span>B =&gt; RenderThen(</a>
<a class="sourceLine" id="cb9-6" title="6">            do_other_things(model),</a>
<a class="sourceLine" id="cb9-7" title="7">            <span class="pp">Msg::</span>A </a>
...
<p>Example:</p>
<div class="sourceCode" id="cb10"><pre class="sourceCode rust"><code class="sourceCode rust"><a class="sourceLine" id="cb10-1" title="1"><span class="kw">fn</span> view(state: <span class="pp">seed::</span>App&lt;Msg, Model&gt;, model: &amp;Model) -&gt; El&lt;Msg&gt; <span class="op">{</span></a>
...
<a class="sourceLine" id="cb13-2" title="2">    <span class="kw">let</span> <span class="kw">mut</span> attributes = <span class="pp">attrs!</span><span class="op">{}</span>;</a>
<a class="sourceLine" id="cb13-3" title="3">    attributes.add_multiple(<span class="pp">At::</span>Class, <span class="pp">vec!</span><span class="op">[</span><span class="st">&quot;A-modicum-of&quot;</span>, <span class="st">&quot;hardly-any&quot;</span><span class="op">]</span>);</a>
<a class="sourceLine" id="cb13-4" title="4"></a>
<a class="sourceLine" id="cb13-5" title="5">    <span class="pp">div!</span><span class="op">[</span> attributes <span class="op">]</span></a>
...
<a class="sourceLine" id="cb14-3" title="3">    <span class="pp">span!</span><span class="op">[</span> <span class="pp">class!</span><span class="op">[</span><span class="st">&quot;calculus&quot;</span>, <span class="st">&quot;chemistry&quot;</span>, <span class="st">&quot;literature&quot;</span><span class="op">]</span> <span class="op">]</span>,</a>
<a class="sourceLine" id="cb14-4" title="4">    <span class="pp">span!</span><span class="op">[</span> <span class="pp">id!</span>(<span class="st">&quot;unique-element&quot;</span>) <span class="op">]</span>,</a>
...
<a class="sourceLine" id="cb15-2" title="2">    <span class="kw">let</span> item_style = <span class="pp">style!</span><span class="op">{</span></a>
<a class="sourceLine" id="cb15-3" title="3">        <span class="st">&quot;margin-top&quot;</span> =&gt; <span class="dv">10</span>;</a>
<a class="sourceLine" id="cb15-4" title="4">        <span class="st">&quot;font-size&quot;</span> =&gt; <span class="st">&quot;1.2em&quot;</span></a>
<a class="sourceLine" id="cb15-5" title="5">    <span class="op">}</span>;</a>
<a class="sourceLine" id="cb15-6" title="6"></a>
<a class="sourceLine" id="cb15-7" title="7">    <span class="pp">div!</span><span class="op">[</span></a>
<a class="sourceLine" id="cb15-8" title="8">        <span class="pp">ul!</span><span class="op">[</span></a>
<a class="sourceLine" id="cb15-9" title="9">            <span class="pp">li!</span><span class="op">[</span> &amp;item_style, <span class="st">&quot;Item 1&quot;</span>, <span class="op">]</span>,</a>
<a class="sourceLine" id="cb15-10" title="10">            <span class="pp">li!</span><span class="op">[</span> &amp;item_style, <span class="st">&quot;Item 2&quot;</span>, <span class="op">]</span>,</a>
...
<a class="sourceLine" id="cb16-3" title="3">    <span class="pp">input!</span><span class="op">[</span> <span class="pp">attrs!</span><span class="op">{</span><span class="pp">At::</span>Typed =&gt; <span class="st">&quot;checkbox&quot;</span>; <span class="pp">At::</span>Checked =&gt; <span class="cn">true</span><span class="op">}</span> <span class="op">]</span></a>
<a class="sourceLine" id="cb16-4" title="4">    <span class="pp">input!</span><span class="op">[</span> <span class="pp">attrs!</span><span class="op">{</span><span class="pp">At::</span>Autofocus =&gt; <span class="cn">true</span><span class="op">}</span> <span class="op">]</span></a>
...
<div class="sourceCode" id="cb17"><pre class="sourceCode rust"><code class="sourceCode rust"><a class="sourceLine" id="cb17-1" title="1"><span class="kw">let</span> <span class="kw">mut</span> attributes = <span class="pp">attrs!</span><span class="op">{}</span>;</a>
...
<div class="sourceCode" id="cb18"><pre class="sourceCode rust"><code class="sourceCode rust"><a class="sourceLine" id="cb18-1" title="1"><span class="kw">fn</span> view(state: <span class="pp">seed::</span>App&lt;Msg, Model&gt;, model: &amp;Model) -&gt; El&lt;Msg&gt; <span class="op">{</span></a>
...
<a class="sourceLine" id="cb19-4" title="4">    <span class="pp">div!</span><span class="op">[</span></a>
<a class="sourceLine" id="cb19-5" title="5">        <span class="pp">h1!</span><span class="op">[</span> &amp;base_style.merge(&amp;<span class="pp">style!</span><span class="op">{</span><span class="st">&quot;grid-row&quot;</span> =&gt; <span class="st">&quot;1 / 2&quot;</span><span class="op">}</span>) <span class="st">&quot;First row&quot;</span> <span class="op">]</span>,</a>
...
<a class="sourceLine" id="cb20-2" title="2">    <span class="at">render</span>()<span class="op">;</span></a>
<a class="sourceLine" id="cb20-3" title="3"><span class="op">}</span></a></code></pre></div>
<p>Example, with optional methods:</p>
<div class="sourceCode" id="cb21"><pre class="sourceCode rust"><code class="sourceCode rust"><a class="sourceLine" id="cb21-1" title="1"><span class="at">#[</span>wasm_bindgen<span class="at">]</span></a>
<a class="sourceLine" id="cb21-2" title="2"><span class="kw">pub</span> <span class="kw">fn</span> render() <span class="op">{</span></a>
<a class="sourceLine" id="cb21-3" title="3">    <span class="pp">seed::App::</span>build(<span class="pp">Model::</span><span class="kw">default</span>(), update, view)</a>
