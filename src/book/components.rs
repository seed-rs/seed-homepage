...
<div class="sourceCode" id="cb1"><pre class="sourceCode rust"><code class="sourceCode rust"><span id="cb1-1"><a href="\#cb1-1"></a>    <span class="kw">fn</span> text_display(text: &amp;<span class="dt">str</span>) -&gt; Node&lt;Msg&gt; <span class="op">{</span></span>
...
<div class="sourceCode" id="cb2"><pre class="sourceCode rust"><code class="sourceCode rust"><span id="cb2-1"><a href="\#cb2-1"></a><span class="kw">fn</span> cols() -&gt; <span class="dt">Vec</span>&lt;Node&lt;Msg&gt;&gt; <span class="op">{</span></span>
...
<span id="cb2-9"><a href="\#cb2-9"></a><span class="kw">fn</span> items() -&gt; Node&lt;Msg&gt; <span class="op">{</span></span>
...
<div class="sourceCode" id="cb3"><pre class="sourceCode rust"><code class="sourceCode rust"><span id="cb3-1"><a href="\#cb3-1"></a><span class="kw">fn</span> items() -&gt; Node&lt;Msg&gt; <span class="op">{</span></span>
