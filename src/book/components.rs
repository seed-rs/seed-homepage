...
<a class="sourceLine" id="cb2-9" title="9"><span class="kw">fn</span> items() -&gt; Node&lt;Msg&gt; <span class="op">{</span></a>
...
<div class="sourceCode" id="cb3"><pre class="sourceCode rust"><code class="sourceCode rust"><a class="sourceLine" id="cb3-1" title="1"><span class="kw">fn</span> items() -&gt; Node&lt;Msg&gt; <span class="op">{</span></a>
